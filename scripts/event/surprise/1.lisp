...
(let ((bonus (get '(1500 2500 4500 6000) (zone))))
  (dialog (tr "An eerie wind blows through the night... <B:0> ")
          (format (tr "An alarm beacon wakes your crew. You investigate, and discover %🪙! ") bonus)
          (tr "<B:0> But just then, a trap springs... and you find yourself facing a devious opponent... the dreaded mimic ship!"))
