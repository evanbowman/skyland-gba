...
(defn on-fadein ()
  (dialog
   (if (room-count (player) 'decimator)
       ...
       "<c:goblin_captain:43>You! We know you have our ssstolen decimator! <B:0> Don't try to hide it - we tracked the energy ssignature to YOUR ship! <B:0> Where isss it?! No matter... we'll tear your castle apart until we find it! <B:0> ATTACK!")))
