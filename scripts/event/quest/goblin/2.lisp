...
(defn on-converge ()
  (let ((m (eval-file "/scripts/event/quest/make_quest_marker.lisp")))
    (if m
        (progn
          (dialog
           (tr "<c:Farmer Meyer:9>Looks like a bad storm's coming this way! Umm, maybe you could do me a favor and relocate my orchard of lemon trees to my brother's island... I'll tell him to pay you 1400@ for each one that you successfully deliver!"))
      ...
      (progn
        (dialog (tr "<c:Farmer Meyer:9>I was going to ask you to help relocate some of these lemon trees, but the storm's getting closer and I need to move out!"))
        (setq on-dialog-closed exit)))))
