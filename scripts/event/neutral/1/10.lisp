...
(dialog "<b:/scripts/misc/img/explorer.img.bin>You come across an explorer's balloon, floating gently in the breeze. You adjust your engines to keep pace with it...")
  ...
  (let ((temp (chr-slots (player)))
    ...
    (if temp
        (progn
          ...
          (if (or (equal (choice 2) 1) (< (scrap) 600))
