...
(dialog
 ...
 (tr "An ancient imperial missile platform contacts you and demands payment..."))
...
(defn/temp pay-toll (receipt)
  (if (< (coins) 600)
      (progn
        ...
        (attack-player (tr "Insufficient funds! The station begins charging its weapons!")))
      (progn
...
(defn on-dialog-declined ()
  (attack-player (tr "The station begins charging its weapons!")))
