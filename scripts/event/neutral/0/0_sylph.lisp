...
(dialog (tr "In the distance, you see an island inhabited by a lone engineer..."))
...
(secret  5 14
         (tr "Emergency Log: Core crystal failure. Day 6. Radio damaged. Supply low."))
...
(defn on-converge ()
  ...
  (if (dialog-await-binary-q-w/lore (tr "She seems capable, invite her aboard?")
                                    (tr "Welcome aboard!")
                                    (tr "Not today.")
                                    (tr '(("crystal deterioration?" .
...
(defn on-dialog-accepted ()
  (find-crew-slot-cb
   (tr "<c:Sylph Engineer:48>Ah. Full capacity. Expected, really. <B:0> Let me help - I'm quite good at spatial optimization. Professional habit.")
   'ladder
   (tr "Place block (1x2):")
   (lambda (x y _)
     (adventure-log-add 7 '())
     ...
     (dialog (tr "<c:Sylph Engineer:48>Hm. Your core... <B:0> It's human make, yes? Crude by our standards, but... <B:0> <d:800> ...it's working. That's more than I can say for mine. <B:0> I'll keep it running well. <B:0> <d:600> It feels good to have systems to maintain again."))
     (defn on-dialog-closed ()
       (setq on-dialog-closed nil)
       (dialog (tr "The engineer joined your crew!"))
       (exit)))))
